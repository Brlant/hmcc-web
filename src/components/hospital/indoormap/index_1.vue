...
<!--&lt;!&ndash;    &lt;!&ndash; 表单 &ndash;&gt;&ndash;&gt;-->
<!--&lt;!&ndash;    <el-form :model="form" :class="['indoor-formedit', editopen ? 'opened' : 'closed']">&ndash;&gt;-->
<!--&lt;!&ndash;      <el-form-item :label="detail ? '详情' : '标点'">&ndash;&gt;-->
<!--&lt;!&ndash;        <el-button type="text" icon="el-icon-close" @click="canvasClick"></el-button>&ndash;&gt;-->
<!--&lt;!&ndash;      </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;      <el-form-item v-if="storey" label="所在楼层：">&ndash;&gt;-->
<!--&lt;!&ndash;        {{ storey.name }}&ndash;&gt;-->
<!--&lt;!&ndash;      </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;      <el-form-item label="点位类型：">&ndash;&gt;-->
<!--&lt;!&ndash;        <el-radio-group v-model="form.pointType" :disabled="form.id && detail">&ndash;&gt;-->
<!--&lt;!&ndash;          <el-radio :label="0">定位点</el-radio>&ndash;&gt;-->
<!--&lt;!&ndash;          <el-radio :label="1">途径点</el-radio>&ndash;&gt;-->
<!--&lt;!&ndash;        </el-radio-group>&ndash;&gt;-->
<!--&lt;!&ndash;      </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;      <el-form-item label="横轴坐标：" label-width="82px">&ndash;&gt;-->
<!--&lt;!&ndash;        <el-input v-model.number="form.xPoint" readonly/>&ndash;&gt;-->
<!--&lt;!&ndash;      </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;      <el-form-item label="纵轴坐标：" label-width="82px">&ndash;&gt;-->
<!--&lt;!&ndash;        <el-input v-model.number="form.yPoint" readonly/>&ndash;&gt;-->
<!--&lt;!&ndash;      </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;      <el-form-item label="标注区域（点位）名称：">&ndash;&gt;-->
<!--&lt;!&ndash;        <el-input v-model="form.pointName" :readonly="form.id && detail" maxlength="10" placeholder="标注区域（点位）名称"/>&ndash;&gt;-->
<!--&lt;!&ndash;      </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;      <el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;        <template v-if="form.id && detail">&ndash;&gt;-->
<!--&lt;!&ndash;          <el-button type="danger" @click="delPoint" style="float: left">删除</el-button>&ndash;&gt;-->
<!--&lt;!&ndash;          <el-button type="primary" @click="detail = false">编辑</el-button>&ndash;&gt;-->
<!--&lt;!&ndash;        </template>&ndash;&gt;-->
<!--&lt;!&ndash;        <template v-else>&ndash;&gt;-->
<!--&lt;!&ndash;          <el-button :type="marking ? 'info' : 'success'" @click="markPoint" style="float: left">{{ marking ? '结束标注' : '关联标注'}}</el-button>&ndash;&gt;-->
<!--&lt;!&ndash;          <el-button @click="canvasClick">取消</el-button>&ndash;&gt;-->
<!--&lt;!&ndash;          <el-button type="primary" @click="savePoint">保存</el-button>&ndash;&gt;-->
<!--&lt;!&ndash;        </template>&ndash;&gt;-->
<!--&lt;!&ndash;      </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;    </el-form>&ndash;&gt;-->
