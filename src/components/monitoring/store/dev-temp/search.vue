<template>
  <search-template :isShow="showSearch" :titleSpan="16" :midSpan="0" :isShowAdvance="false" @search="search"
    ...
    <template slot="btn">
      <slot name="btn">
        <!--<el-button :disabled="doing" @click="exportData" size="small" v-has="'ccs-devdata-export'">-->
          ...
          <!--{{doing ? '正在导出...': '导出温度数据'}}-->
        <!--</el-button>-->
        <el-button size="small" @click="$router.push('/monitoring/store')" v-show="!$route.meta.showDev">
    ...
    <template slot="content">
      <el-form class="advanced-query-form" onsubmit="return false">
        <el-row>
          <el-col :span="9">
            <oms-form-row label="上报时间" :span="5" :required="true">
              <el-date-picker v-model="times1" type="datetimerange" :default-time="['00:00:00', '23:59:59']"
                              placeholder="请选择" @change="timeChange"/>
            </oms-form-row>
          </el-col>
          <el-col :span="9">
