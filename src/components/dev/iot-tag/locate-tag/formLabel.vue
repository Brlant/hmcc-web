...
<!--          ></el-option>-->
      ...
      <el-form-item label="标签SN号" prop="tagSnNumber" label-width="80px" >
        <el-input v-model="formData.tagSnNumber" maxlength="20" show-word-limit placeholder="请输入标签SN号" @change="handleTagSnNumberMacAddress($event,1)"></el-input>
      </el-form-item>
      <el-form-item label="MAC地址" prop="macAddress" label-width="80px" >
        <el-input v-model="formData.macAddress" maxlength="12" show-word-limit placeholder="请输入MAC地址" @change="handleTagSnNumberMacAddress($event,2)"></el-input>
      </el-form-item>
    </el-form>
    <div slot="footer" >
